...
final class RecorderView: UIView {
    ...
    //        ViewFactory.create.button(imageSystemName: Buttons.pause.rawValue,
    ...
    func updateState(with state: RecorderState) {
        ...
        switch state {
            ...
            case .playingPaused:
                ...
                //            case .hasPermission(let allowed):
                //                recordButton.isEnabled = allowed
                //                clearButton.isEnabled = allowed
